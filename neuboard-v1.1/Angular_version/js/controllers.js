function MainCtrl() {
 // placeholder for main controller
...
function AddDynamicNotificationsExampleCtrl($scope, $modal) {
...
angular
    ...
    .controller('chartJsBarCtrl', chartJsBarCtrl)
    ...
    .controller('AddDynamicNotificationsExampleCtrl', AddDynamicNotificationsExampleCtrl)
    ...
    .controller('sparklineCtrl', sparklineCtrl)
